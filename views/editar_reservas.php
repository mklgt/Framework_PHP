...
<?php
    foreach ($reservasUsuario as $reserva) {
        ...
        echo '<td><button type="button" class="btn btn-secondary" id="btnEditar">Editar</button><button type="button" class="btn btn-danger" style="margin-left: 3px;" id="btnEliminar" onclick="mostrarEliminar(this)">Eliminar</button></td>';
        echo "</tr>";
    }
?>
        </tbody>
